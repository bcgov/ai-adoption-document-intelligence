...
- [ ] **Scenario 1**: `source-catalog-utils.ts` icon + color resolvers
...
- [ ] **Scenario 2**: "Sources" section above activity categories in `ActivityPalette`
...
- [ ] **Scenario 3**: Section lists `source.api` + `source.upload`
...
- [ ] **Scenario 4**: Dragging a source entry creates a `SourceNode`
