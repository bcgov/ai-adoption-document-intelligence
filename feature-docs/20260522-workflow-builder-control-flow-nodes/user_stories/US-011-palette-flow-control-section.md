...
- [ ] **Scenario 1**: New "Flow Control" section appears at the top of the palette
...
- [ ] **Scenario 2**: Each Flow-Control entry has an icon, display name, and short description
...
- [ ] **Scenario 3**: Clicking an entry adds a skeleton node with correct defaults
...
- [ ] **Scenario 4**: Skeleton position uses the existing add-position logic
