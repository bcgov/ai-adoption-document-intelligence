...
- [ ] **Scenario 3**: PollUntil, HumanGate, ChildWorkflow render as rectangles with the type's icon
...
- [ ] **Scenario 4**: All control-flow nodes are selectable / draggable / connectable like activities
