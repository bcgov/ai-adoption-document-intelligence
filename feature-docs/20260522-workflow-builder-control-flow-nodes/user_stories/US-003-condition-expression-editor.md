...
- [x] **Scenario 1**: Renders all five expression kinds with their proper bodies
...
- [x] **Scenario 2**: `ValueRef` editor supports a Ref / Literal toggle that persists exactly one
...
- [x] **Scenario 3**: Switching operator-type preserves what fits
...
- [x] **Scenario 4**: Logical AND/OR supports add/remove operands with visual indent
...
- [x] **Scenario 5**: Round-trips a 3-level deep nested expression
...
- [x] **Scenario 6**: Reuses the existing VariablePicker for Ref mode
