...
- [x] **Scenario 1**: Renders existing cases as a list of editable rows
...
- [x] **Scenario 2**: Add Case appends an empty case
...
- [x] **Scenario 3**: Remove Case removes the targeted case
...
- [x] **Scenario 4**: Editing a row's condition or edgeId propagates to `onConfigChange`
...
- [x] **Scenario 5**: `defaultEdge` is editable via an EdgePicker scoped to outgoing edges from this node
