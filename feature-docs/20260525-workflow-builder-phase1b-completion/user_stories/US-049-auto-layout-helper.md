...
- [x] **Scenario 1**: Helper at `canvas/auto-layout.ts`
...
- [x] **Scenario 2**: Re-use the existing dagre import from the read-only renderer
...
- [x] **Scenario 3**: Top-bar "Auto-arrange" button
...
- [x] **Scenario 4**: Auto-arrange treats group sub-graphs as compound nodes (if simplified view is OFF)
