...
- [ ] **Scenario 1**: Top-bar button reveals when ≥ 2 nodes selected
...
- [ ] **Scenario 4**: A node can only belong to one group at a time
...
- [ ] **Scenario 5**: Auto-numbering avoids collisions
