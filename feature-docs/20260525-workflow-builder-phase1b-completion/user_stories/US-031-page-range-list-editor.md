...
- [x] **Scenario 1**: Renders one row per existing range
...
- [x] **Scenario 2**: Add / remove row controls
...
- [x] **Scenario 3**: `start <= end` per-row validation
...
- [x] **Scenario 4**: `start` and `end` are 1-based positive integers
