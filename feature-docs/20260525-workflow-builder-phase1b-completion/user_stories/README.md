...
- [ ] **US-031** (PageRangeListEditor)
- [ ] **US-032** (route `page-range-list`)
- [ ] **US-033** (ConfusionMapEditor)
- [ ] **US-034** (route `confusion-map-editor`)
- [ ] **US-035** (KeywordPatternEditor)
- [ ] **US-036** (route `keyword-pattern-editor`)
- [ ] **US-037** (ClassificationRuleEditor shell)
- [ ] **US-038** (per-rule pattern rows)
