...
- [ ] **Scenario 1**: Hover-trigger surface on outgoing source handle
...
- [ ] **Scenario 2**: Picker dismisses on click-away
...
- [ ] **Scenario 3**: Picking an entry adds + connects in one action
...
- [ ] **Scenario 4**: New node is auto-selected and fit into view
