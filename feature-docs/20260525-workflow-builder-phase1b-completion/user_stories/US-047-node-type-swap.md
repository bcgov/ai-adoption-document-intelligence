...
- [x] **Scenario 1**: "Change activity type" opens an activity picker
...
- [x] **Scenario 2**: Picking a new type preserves intersecting parameters
...
- [x] **Scenario 3**: Existing edges remain
...
- [x] **Scenario 4**: A swap that violates Zod (e.g., required new field) shows a save-time error via the existing validation drawer
...
- [x] **Scenario 5**: Control-flow nodes can't be swapped
