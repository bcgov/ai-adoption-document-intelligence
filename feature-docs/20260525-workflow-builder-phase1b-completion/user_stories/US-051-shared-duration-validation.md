...
- [x] **Scenario 1**: Helper in shared package
...
- [x] **Scenario 2**: Frontend imports from the package
...
- [x] **Scenario 3**: Validator surfaces errors at duration fields
...
- [x] **Scenario 4**: Coverage for the four duration fields
...
- [x] **Scenario 5**: Backend + temporal validators inherit automatically
