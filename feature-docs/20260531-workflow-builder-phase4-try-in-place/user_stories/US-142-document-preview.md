...
- [x] **Scenario 2**: MultiPageDocument — first page large + horizontal strip
...
- [x] **Scenario 3**: SinglePageDocument — one large thumbnail
...
- [x] **Scenario 4**: Reuses existing `<BlobImage>` component
...
- [x] **Scenario 5**: Click large thumbnail → full-size modal
