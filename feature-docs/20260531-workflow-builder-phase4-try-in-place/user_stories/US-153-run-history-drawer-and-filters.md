...
- [x] **Scenario 1**: Top-bar "Run history" button
...
- [x] **Scenario 2**: `useWorkflowRuns` infinite-query hook
...
- [x] **Scenario 3**: `RunHistoryDrawer` layout
...
- [x] **Scenario 4**: `RunHistoryFilters` component
...
- [x] **Scenario 5**: Cursor-pagination on scroll
...
- [x] **Scenario 6**: Tests cover hook + drawer + filters
