...
- [ ] **Scenario 2**: Returns Temporal workflow input
...
- [ ] **Scenario 3**: Falls back to cache-row reconstruction when Temporal input is missing
...
- [ ] **Scenario 4**: 403 / 404 surface for cross-workflow / non-existent runs
...
- [ ] **Scenario 6**: Controller spec covers all paths
