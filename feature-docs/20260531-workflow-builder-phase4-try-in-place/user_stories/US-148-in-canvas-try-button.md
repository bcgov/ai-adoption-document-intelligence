...
- [ ] **Scenario 1**: Button placement + icon
...
- [ ] **Scenario 2**: Disabled state in create mode
...
- [ ] **Scenario 3**: Click opens RunWorkflowDrawer pre-selected on Try tab
...
- [ ] **Scenario 4**: Hidden for source.upload-only workflows
...
- [ ] **Scenario 5**: Visible for mixed workflows (source.api + source.upload)
