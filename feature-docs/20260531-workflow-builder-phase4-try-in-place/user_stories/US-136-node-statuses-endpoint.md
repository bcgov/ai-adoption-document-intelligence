...
- [x] **Scenario 2**: Query Temporal + return the map
...
- [x] **Scenario 3**: 404 when Temporal handle not found
...
- [x] **Scenario 4**: 410 Gone when run retention-cleaned
...
- [x] **Scenario 6**: Controller spec covers happy + 404 + 410 paths
