...
- [x] **Scenario 2**: Label pill + confidence bar layout
...
- [x] **Scenario 3**: Confidence colour bands
...
- [x] **Scenario 4**: Multi-result arrays (when the node emits an array of Classifications)
...
- [x] **Scenario 5**: Confidence rendering edge cases
