...
- [x] **Scenario 1**: `RunRow` component layout
...
- [x] **Scenario 2**: Replay button click flow
...
- [x] **Scenario 3**: Canvas enters replay mode
...
- [x] **Scenario 4**: "Clear" replay restores live mode
...
- [x] **Scenario 5**: Editing parameters in Replay mode is allowed but flagged
    - **Given** Replay mode is active
