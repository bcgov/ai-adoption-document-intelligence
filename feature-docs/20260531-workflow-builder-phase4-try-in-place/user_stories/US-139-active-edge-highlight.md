...
- [x] **Scenario 1**: Pure helper `computeActiveEdges`
...
- [x] **Scenario 2**: Multiple active edges supported simultaneously
...
- [x] **Scenario 3**: No active edges in terminal state
...
- [x] **Scenario 4**: `WorkflowEdge.tsx` accepts and renders the active state
...
- [x] **Scenario 5**: Canvas wires `computeActiveEdges` into edge data
...
- [x] **Scenario 6**: Unit tests for the helper
