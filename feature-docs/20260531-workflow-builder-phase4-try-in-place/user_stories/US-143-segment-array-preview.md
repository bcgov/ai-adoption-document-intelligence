...
- [x] **Scenario 2**: Parent document rendered at display size with overlays
...
- [x] **Scenario 3**: Segment pagination — > 6 segments
...
- [x] **Scenario 4**: Mixed parent documents
...
- [x] **Scenario 5**: Hover tooltip on each overlay
