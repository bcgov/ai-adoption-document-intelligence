...
- [x] **Scenario 1**: Button label + tooltip update
...
- [x] **Scenario 2**: Successful upload sets `activeRunId` in canvas state
...
- [x] **Scenario 3**: Polling loops start automatically
...
- [x] **Scenario 4**: Cancel-on-new-Try is server-side; UI just sets the new runId
...
- [x] **Scenario 5**: Error handling preserved
