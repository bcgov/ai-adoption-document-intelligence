...
- [x] **Scenario 1**: Version `<Select>` appears after a library is selected
...
- [x] **Scenario 2**: Loading state for the version fetch
...
- [x] **Scenario 3**: Confirm returns the right shape
...
- [x] **Scenario 4**: Confirm disabled until a library row is selected
