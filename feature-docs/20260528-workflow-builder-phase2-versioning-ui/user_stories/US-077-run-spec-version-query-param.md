...
- [ ] **Scenario 1**: Endpoint accepts `?workflowVersionId=`
...
- [ ] **Scenario 2**: Omitting the query param preserves existing behaviour
...
- [ ] **Scenario 3**: Unknown version id → 404
    - **Given** a query param `workflowVersionId` that doesn't exist
    - **When** the endpoint is called
    - **Then** the response is 404

- [ ] **Scenario 4**: Version from a different lineage → 400
...
- [ ] **Scenario 5**: Swagger documents the query param
