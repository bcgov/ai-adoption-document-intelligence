...
- [x] **Scenario 1**: Endpoint exists and returns the version's `WorkflowInfo`
...
- [x] **Scenario 2**: Unknown version id → 404
    - **Given** a `:versionId` that does not exist
    - **When** the endpoint is called
    - **Then** the response is 404

- [x] **Scenario 3**: Version belongs to a different lineage → 404
