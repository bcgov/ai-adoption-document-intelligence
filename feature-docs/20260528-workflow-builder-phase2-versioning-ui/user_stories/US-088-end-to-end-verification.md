...
- [x] **Scenario 1**: History drawer + head badge
...
- [x] **Scenario 2**: Compare-to-head modal
...
- [x] **Scenario 3**: Revert flow + canvas reload
    - **Given** the drawer is open
...
- [x] **Scenario 4**: Run drawer per-version
...
- [x] **Scenario 5**: Library pin persistence
...
- [x] **Scenario 6**: Zero `pageerror` events through the entire walkthrough
