...
- [x] **Scenario 1**: Gauge is registered and appears in the metrics endpoint
...
- [x] **Scenario 2**: `recordAlert` sets the gauge to 1 for the given type and severity
...
- [x] **Scenario 3**: `clearAlert` sets the gauge to 0 for the given type
...
- [x] **Scenario 4**: Multiple alert types are tracked independently
...
- [x] **Scenario 5**: Clearing one alert type does not affect others
