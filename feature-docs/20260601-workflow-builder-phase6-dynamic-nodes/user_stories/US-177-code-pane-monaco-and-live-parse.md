...
- [ ] **Scenario 1**: Monaco TS editor mounted with TypeScript language mode
...
- [ ] **Scenario 3**: Live signature parse strip below the editor
...
- [ ] **Scenario 4**: Publish-time errors render as Monaco gutter markers
...
- [ ] **Scenario 5**: Editor exposes the current text via a `onChange(text)` prop
...
- [ ] **Scenario 6**: Tests cover boilerplate + live parse + markers + onChange
