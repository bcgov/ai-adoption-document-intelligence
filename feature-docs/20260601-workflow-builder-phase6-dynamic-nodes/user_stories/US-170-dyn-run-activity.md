...
- [x] **Scenario 1**: Activity declared + registered alongside static activities
...
- [x] **Scenario 2**: Permission flags computed + included in runner request
...
- [x] **Scenario 3**: Ambient env vars passed in the runner request body
...
- [x] **Scenario 4**: HTTP call to the runner with proper timeouts
...
- [x] **Scenario 5**: Runner failures mapped to typed errors
...
- [x] **Scenario 6**: Output structural check + parse errors
