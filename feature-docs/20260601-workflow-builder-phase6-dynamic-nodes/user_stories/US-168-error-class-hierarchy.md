...
- [ ] **Scenario 1**: New `errors.ts` exports seven error classes
...
- [ ] **Scenario 2**: Each error class carries structured data
...
- [ ] **Scenario 3**: Each error class has a `toErrorMessage()` method
...
- [ ] **Scenario 4**: Errors are Temporal-serialisable
...
- [ ] **Scenario 5**: Unit tests cover prefix + structured payload + instanceof
