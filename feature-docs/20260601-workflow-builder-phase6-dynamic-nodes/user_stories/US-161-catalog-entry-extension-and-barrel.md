...
- [x] **Scenario 1**: `ActivityCatalogEntry` type extended with three optional fields
...
- [x] **Scenario 2**: Bulk catalog invariant test untouched by the extension
...
- [x] **Scenario 3**: Shared-package barrel exports parser + types + kinds together
...
- [x] **Scenario 4**: Package `npm test` + `npm run build` both green
...
- [x] **Scenario 5**: Integration smoke — parser output assignable to catalog-entry type
