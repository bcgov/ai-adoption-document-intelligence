...
- [ ] **Scenario 1**: New `PUT /api/dynamic-nodes/:slug` endpoint declared
...
- [ ] **Scenario 2**: 200 on success — body carries the new version number
...
- [ ] **Scenario 3**: 404 on unknown or soft-deleted slug
...
- [ ] **Scenario 4**: 409 on `@name` differing from path slug
...
- [ ] **Scenario 5**: 400 on validation failure — same structured `errors` as US-165
...
- [ ] **Scenario 6**: Full Swagger decorators on the endpoint
