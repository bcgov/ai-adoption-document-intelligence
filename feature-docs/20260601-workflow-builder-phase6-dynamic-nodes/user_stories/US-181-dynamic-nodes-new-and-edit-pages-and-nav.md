...
- [ ] **Scenario 3**: Top-bar nav link "Dynamic nodes"
...
- [ ] **Scenario 4**: Full-page layout for the editor
...
- [ ] **Scenario 5**: After-delete navigation
...
- [ ] **Scenario 6**: Tests cover both pages + nav
