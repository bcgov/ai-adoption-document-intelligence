...
- [x] **Scenario 1**: Route registered + page renders the table
...
- [x] **Scenario 2**: List data sourced from `useDynamicNodeList`
...
- [x] **Scenario 3**: Row actions — Edit + Delete
    - **Given** a row
...
- [x] **Scenario 6**: Tests cover render + actions
