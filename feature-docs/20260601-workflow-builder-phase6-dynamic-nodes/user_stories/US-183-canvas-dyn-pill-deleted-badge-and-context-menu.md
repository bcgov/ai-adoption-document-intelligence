...
- [x] **Scenario 1**: DYN pill on canvas dynamic-node renderer
...
- [x] **Scenario 2**: "Deleted" badge when the slug is missing from the merged catalog
...
- [x] **Scenario 3**: Right-click "Edit script" entry in NodeContextMenu
...
- [x] **Scenario 4**: In-situ modal closes + canvas updates after publish
...
- [x] **Scenario 5**: "Deleted" badge disables Try
...
- [x] **Scenario 6**: Tests cover all three affordances
