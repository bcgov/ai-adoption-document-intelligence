...
- [ ] **Scenario 1**: Summary displays selected input and output formats
...
- [ ] **Scenario 2**: Summary displays a read-only preview of the field mapping
...
- [ ] **Scenario 3**: Large mappings display a truncated summary
...
- [ ] **Scenario 4**: Error badge displays when the last execution failed
