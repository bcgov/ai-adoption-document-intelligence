...
- [x] **Scenario 1**: XML envelope editor is only visible when output format is XML
...
- [x] **Scenario 2**: Admin can type or paste an envelope template
...
- [x] **Scenario 3**: Admin can upload an XML file to populate the envelope template
...
- [x] **Scenario 4**: Admin can export/download the current envelope as an .xml file
