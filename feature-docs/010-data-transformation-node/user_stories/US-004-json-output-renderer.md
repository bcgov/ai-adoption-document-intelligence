...
- [ ] **Scenario 1**: Flat resolved mapping serializes to valid JSON object
...
- [ ] **Scenario 2**: Nested mapping objects serialize to nested JSON
...
- [ ] **Scenario 3**: Array values in mapping serialize correctly
...
- [ ] **Scenario 4**: Rendering failure throws structured error
