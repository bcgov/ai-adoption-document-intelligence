...
## Acceptance Criteria
- [x] **Scenario 1**: Requestor creates a resource in their own group
...
- [x] **Scenario 2**: Requestor attempts to create a resource in a group they don't belong to
...
- [x] **Scenario 3**: Create request missing group_id is rejected
...
- [x] **Scenario 4**: Applies to all four top-level resource types
...
- [x] **Scenario 5**: Unit tests cover creation enforcement
