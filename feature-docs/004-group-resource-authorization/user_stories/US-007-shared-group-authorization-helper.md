...
## Acceptance Criteria
- [ ] **Scenario 1**: JWT user passes group membership check
...
- [ ] **Scenario 4**: API key fails group membership check
...
- [ ] **Scenario 6**: Requestor is a member of multiple groups
...
- [ ] **Scenario 7**: Unit tests cover all paths
