...
## Acceptance Criteria
- [ ] **Scenario 1**: Member successfully requests an API key for their group
...
- [ ] **Scenario 2**: Non-member cannot request an API key for a group
...
- [ ] **Scenario 3**: Requesting a new key updates user_id on the existing record
...
- [ ] **Scenario 4**: Unit tests cover the request flow
