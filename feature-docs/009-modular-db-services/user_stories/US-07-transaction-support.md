...
## Acceptance Criteria
- [x] **Scenario 1**: PrismaService exposes a transaction() helper
    - **Given** `PrismaService`
...
- [x] **Scenario 2**: All db-service methods accept an optional tx parameter
...
- [x] **Scenario 3**: Service methods pass tx through to db-service calls
...
- [x] **Scenario 4**: Cross-module transactions use prismaService.transaction()
...
- [x] **Scenario 5**: Controllers do not initiate or receive transactions
