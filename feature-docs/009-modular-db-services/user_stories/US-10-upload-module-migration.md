...
## Acceptance Criteria
- [x] **Scenario 1**: Upload module no longer injects DatabaseService
    - **Given** all classes in the `upload` module
    - **When** reviewing their constructors
    - **Then** none of them inject `DatabaseService`

- [x] **Scenario 2**: Upload module uses the correct module services
...
- [x] **Scenario 3**: Upload module does not inject any db-services from other modules
    - **Given** all classes in the `upload` module
    - **When** reviewing their constructors
    - **Then** none of them inject a db-service from another module

- [x] **Scenario 4**: All existing upload tests still pass
