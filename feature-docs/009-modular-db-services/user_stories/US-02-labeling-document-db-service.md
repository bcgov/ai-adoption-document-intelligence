...
## Acceptance Criteria
- [x] **Scenario 1**: LabelingDocumentDbService lives in the labeling module
...
- [x] **Scenario 2**: LabelingDocumentDbService exposes only the required methods
...
- [x] **Scenario 3**: LabelingDocumentDbService is registered as a provider but not exported
...
- [x] **Scenario 4**: LabelingDocumentDbService uses PrismaService via private getter
    - **Given** the new `LabelingDocumentDbService`
...
- [x] **Scenario 6**: Unit tests exist for LabelingDocumentDbService
    - **Given** the new `LabelingDocumentDbService`
