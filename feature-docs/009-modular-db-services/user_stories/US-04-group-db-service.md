...
## Acceptance Criteria
- [x] **Scenario 1**: GroupDbService is created at the correct path
...
- [x] **Scenario 2**: GroupDbService exposes the required methods
...
- [x] **Scenario 6**: Inline queries are removed from DatabaseService
...
- [x] **Scenario 7**: Unit tests exist for GroupDbService
    - **Given** the new `GroupDbService`
