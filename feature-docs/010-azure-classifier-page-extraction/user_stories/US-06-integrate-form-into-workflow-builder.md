...
## Acceptance Criteria
- [x] **Scenario 1**: Form renders for azureClassify.submit nodes
...
- [x] **Scenario 2**: Generic activity form still renders for all other activity types
...
- [x] **Scenario 3**: azureClassify.submit appears in the activity type dropdown/list
