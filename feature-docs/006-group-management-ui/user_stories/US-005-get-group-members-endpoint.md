...
## Acceptance Criteria
- [x] **Scenario 1**: Returns all members for a group admin
...
- [x] **Scenario 2**: Returns all members for a system admin
    - **Given** a caller who is a system admin
    - **When** `GET /api/groups/:groupId/members` is called
    - **Then** a `200 OK` response is returned with the full member list

- [x] **Scenario 3**: Returns all members for a regular group member
...
- [x] **Scenario 4**: Returns `403` for a caller who is not a member
    - **Given** a caller who is neither a member, group admin, nor system admin of the group
    - **When** `GET /api/groups/:groupId/members` is called
    - **Then** a `403 Forbidden` response is returned

- [x] **Scenario 5**: Controller and service unit tests pass
