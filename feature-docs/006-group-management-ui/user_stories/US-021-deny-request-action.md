...
## Acceptance Criteria
- [x] **Scenario 1**: Clicking Deny opens a confirmation dialog
...
- [x] **Scenario 2**: Confirming the dialog denies the request
