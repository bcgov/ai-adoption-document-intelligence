...
## Acceptance Criteria
- [ ] **Scenario 1**: Group admin successfully approves a request
...
- [ ] **Scenario 2**: Group admin successfully denies a request
    - **Given** a caller who is a group admin for the group the request belongs to and a `PENDING` request
