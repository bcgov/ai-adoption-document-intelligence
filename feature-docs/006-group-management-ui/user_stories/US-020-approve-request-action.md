...
## Acceptance Criteria
- [x] **Scenario 1**: Clicking Approve on a PENDING request approves it immediately
...
- [x] **Scenario 2**: An optional reason field is presented before confirming
...
- [x] **Scenario 3**: Approve button is only visible on PENDING rows
