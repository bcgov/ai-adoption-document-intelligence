...
## Acceptance Criteria
- [x] **Scenario 1**: Returns all requests for a group admin
...
- [x] **Scenario 2**: Returns `403` for a non-admin group member
...
- [x] **Scenario 4**: System admin can access requests for any group
