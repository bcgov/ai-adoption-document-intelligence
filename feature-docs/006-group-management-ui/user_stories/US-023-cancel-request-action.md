...
## Acceptance Criteria
- [x] **Scenario 1**: Cancel button is visible on PENDING rows only
...
- [x] **Scenario 2**: Clicking Cancel opens a confirmation dialog
...
- [x] **Scenario 3**: Confirming cancels the request
