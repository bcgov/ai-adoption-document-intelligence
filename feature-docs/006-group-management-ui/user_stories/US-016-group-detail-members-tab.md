...
## Acceptance Criteria
- [x] **Scenario 1**: Members tab is only shown if the user is a group member, group admin, or system admin
...
- [x] **Scenario 2**: Members tab displays all current members
...
- [x] **Scenario 3**: Non-admin members see the table without the remove action
...
- [x] **Scenario 4**: Group admin / system admin see the Remove button per row
