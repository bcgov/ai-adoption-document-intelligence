...
| # | Story | Status |
|---|-------|--------|
| US-003 | [Source `/me` Endpoint Roles from the Database](./US-003-me-endpoint-roles-from-db.md) | - [ ] |
...
| # | Story | Status |
|---|-------|--------|
| US-011 | [`POST /api/groups` — Create Group (System Admin Only)](./US-011-create-group-endpoint.md) | - [ ] |
