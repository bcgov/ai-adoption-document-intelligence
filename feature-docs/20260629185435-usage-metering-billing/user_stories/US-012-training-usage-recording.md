...
- [x] **Scenario 1**: Template model training records a UsageEvent after successful Azure submission
...
- [x] **Scenario 2**: Classifier training records a UsageEvent after successful Azure submission
...
- [x] **Scenario 3**: Pre-flight cap check blocks template model training when over cap
...
- [x] **Scenario 4**: Pre-flight cap check blocks classifier training when over cap
...
- [x] **Scenario 5**: Training cost is looked up from the active rate version's training_costs
