...
- [x] **Scenario 1**: Groups with no cap configured always pass the check
...
- [x] **Scenario 2**: Group under cap passes and workflow proceeds
...
- [x] **Scenario 3**: Group over cap is rejected with HTTP 402
...
- [x] **Scenario 4**: Concurrent requests cannot both pass when they would collectively exceed the cap
...
- [x] **Scenario 5**: Current spend is read from UsagePeriodSummary, not recalculated
