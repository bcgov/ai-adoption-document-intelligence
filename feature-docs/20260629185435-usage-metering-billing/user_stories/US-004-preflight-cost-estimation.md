...
- [x] **Scenario 1**: Linear workflow returns sum of all activity node costs
...
- [x] **Scenario 2**: Branching workflow returns cost of the most expensive branch
...
- [x] **Scenario 3**: Per-page activities use max_pages_assumption for estimation
...
- [x] **Scenario 4**: Activities absent from the rate version contribute zero cost
...
- [x] **Scenario 5**: Estimation uses the currently active rate version
