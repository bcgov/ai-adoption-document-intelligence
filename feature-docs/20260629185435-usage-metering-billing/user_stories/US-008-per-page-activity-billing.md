...
- [x] **Scenario 1**: azureOcr.extract activity returns _metered_quantity in its result
...
- [x] **Scenario 2**: Interceptor detects per_page cost type and reads _metered_quantity
...
- [x] **Scenario 3**: units_consumed is correctly calculated as quantity × per-page rate
...
- [x] **Scenario 4**: Missing or zero _metered_quantity results in zero units charged
