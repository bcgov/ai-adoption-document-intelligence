...
- [x] **Scenario 1**: Separate docker-compose.monitoring.yml created
...
- [x] **Scenario 2**: Promtail auto-discovers container logs via Docker socket
...
- [x] **Scenario 3**: Community-standard ports exposed locally
...
- [x] **Scenario 4**: Data persists via Docker volumes
...
- [x] **Scenario 5**: Compatible with existing startup scripts and VS Code task
