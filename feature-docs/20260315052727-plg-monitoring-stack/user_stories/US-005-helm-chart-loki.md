...
- [ ] **Scenario 1**: Helm chart structure created
...
- [ ] **Scenario 2**: Loki configured for NDJSON log parsing
...
- [ ] **Scenario 3**: 30-day log retention enforced
...
- [ ] **Scenario 4**: Helm values configurable per environment
