...
- [ ] **Scenario 1**: Client IP extracted from X-Forwarded-For header
...
- [ ] **Scenario 2**: Fallback to X-Real-IP header
...
- [ ] **Scenario 3**: Fallback to socket remote address
...
- [ ] **Scenario 4**: ClientIp appears in NDJSON log output
...
- [ ] **Scenario 5**: LogContext interface updated for clientIp
