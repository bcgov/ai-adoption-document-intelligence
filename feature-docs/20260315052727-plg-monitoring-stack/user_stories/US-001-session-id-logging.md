...
- [x] **Scenario 1**: SessionId added to request context
...
- [x] **Scenario 2**: SessionId appears in NDJSON log output
...
- [x] **Scenario 3**: LogContext interface updated in shared logging package
...
- [x] **Scenario 4**: Unauthenticated requests omit sessionId
