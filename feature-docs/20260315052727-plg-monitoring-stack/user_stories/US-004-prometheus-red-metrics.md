...
- [ ] **Scenario 1**: /metrics endpoint exposes RED metrics
...
- [ ] **Scenario 2**: Metrics are collected for every HTTP request
...
- [ ] **Scenario 3**: Node.js runtime default metrics are exposed
...
- [ ] **Scenario 4**: /metrics endpoint is not publicly accessible on OpenShift
