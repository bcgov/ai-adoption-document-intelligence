...
- [ ] **Scenario 1**: Loki data source pre-configured in dashboard
...
- [ ] **Scenario 2**: Filter by service label
...
- [ ] **Scenario 3**: Filter by userId and sessionId
...
- [ ] **Scenario 4**: Filter by log level with error quick-filter
