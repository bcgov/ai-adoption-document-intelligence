...
- [x] **Scenario 1**: Complete resource deletion
...
- [x] **Scenario 2**: Instance name from git branch
...
- [x] **Scenario 3**: Explicit instance name
...
- [x] **Scenario 4**: No interactive prompts
...
- [x] **Scenario 5**: Last instance cleanup
...
- [x] **Scenario 6**: Teardown does not auto-backup
