...
- [x] **Scenario 1**: Workflow builds all service images
...
- [x] **Scenario 2**: Images are tagged correctly
...
- [x] **Scenario 3**: No PAT required for push
...
- [x] **Scenario 4**: Images are publicly pullable
...
- [x] **Scenario 5**: Existing CI/CD remains untouched
