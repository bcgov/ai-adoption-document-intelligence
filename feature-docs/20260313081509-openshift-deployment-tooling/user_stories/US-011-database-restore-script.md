...
- [x] **Scenario 1**: Restore from local backup file
...
- [x] **Scenario 2**: Cross-instance restore
...
- [x] **Scenario 3**: Destroy-and-rebuild workflow
...
- [x] **Scenario 4**: Missing backup file error
...
- [x] **Scenario 5**: Restore uses pg_restore via pod exec
