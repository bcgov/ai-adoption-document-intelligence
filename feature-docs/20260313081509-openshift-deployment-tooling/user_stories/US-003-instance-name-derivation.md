...
- [x] **Scenario 1**: Branch name is sanitized for Kubernetes
...
- [x] **Scenario 2**: Special characters are handled
...
- [x] **Scenario 3**: Instance name used as resource prefix and label
...
- [x] **Scenario 4**: Manual instance name override
