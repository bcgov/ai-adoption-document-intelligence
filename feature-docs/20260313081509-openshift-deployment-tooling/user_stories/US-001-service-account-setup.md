...
- [x] **Scenario 1**: Successful service account creation
...
- [x] **Scenario 2**: Token file is gitignored
...
- [x] **Scenario 3**: Script fails gracefully without oc login
...
- [x] **Scenario 4**: Re-running setup is idempotent
