...
- [ ] **Scenario 1**: `invalidator-table.ts` declares the per-tool invalidation keys
...
- [ ] **Scenario 2**: Runtime subscribes to tool-call-complete events
...
- [ ] **Scenario 3**: `createWorkflow` invalidates the workflow LIST + binds the conversation
...
- [ ] **Scenario 4**: Live canvas smoke test
...
- [ ] **Scenario 5**: Tests cover invalidator table + subscription
