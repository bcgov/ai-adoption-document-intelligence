...
- [ ] **Scenario 1**: `useDrainQueueOnAddNode` listens to runtime events
...
- [ ] **Scenario 2**: After upload completes, queue is drained
...
- [ ] **Scenario 3**: Upload failure leaves the file in the queue
...
- [ ] **Scenario 4**: Hook mounted in the drawer
...
- [ ] **Scenario 5**: Tests cover the drain flow
