...
- [x] **Scenario 1**: `getWorkflow` tool registered
...
- [x] **Scenario 2**: `listDynamicNodes` + `getDynamicNode` tools registered
...
- [x] **Scenario 3**: `listSourceUploadAttachments` tool registered + new service method
...
- [x] **Scenario 4**: Tools self-register via `AgentModule.onModuleInit`
...
- [x] **Scenario 5**: Unit tests for each tool handler
