...
- [x] **Scenario 1**: `declareCtx` tool registered
...
- [x] **Scenario 2**: `setCtxKind` tool registered
    - **Given** the same file
    - **When** read after the change
...
- [x] **Scenario 3**: Phase 3 kind validation propagates
...
- [x] **Scenario 4**: `setCtxKind` triggering downstream binding-walk errors
...
- [x] **Scenario 5**: Unit tests cover both tools
