...
- [x] **Scenario 1**: Navigation fires on `createWorkflow` tool-call-complete
...
- [x] **Scenario 2**: Drawer state survives the navigation
...
- [x] **Scenario 3**: Conversation rebinds to the new workflow
...
- [x] **Scenario 4**: User-on-different-route case respected
