...
- [ ] **Scenario 1**: `ParseErrorList` sub-component
...
- [ ] **Scenario 2**: `AgentToolCallCard` dispatches to `ParseErrorList` on the right error code
...
- [ ] **Scenario 3**: First parse error highlighted by default
...
- [ ] **Scenario 4**: Card shows "Revising…" indicator after the error
