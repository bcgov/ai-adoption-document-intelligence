...
- [x] **Scenario 1**: `publishDynamicNode` tool registered
...
- [x] **Scenario 2**: `updateDynamicNode` tool registered
    - **Given** the same file
    - **When** read after the change
...
- [x] **Scenario 3**: `deleteDynamicNode` tool registered
    - **Given** the same file
    - **When** read after the change
...
- [x] **Scenario 4**: `ParseError[]` round-trips with line + column intact
...
- [x] **Scenario 5**: Unit tests cover all three tools + the escape-hatch revision path
