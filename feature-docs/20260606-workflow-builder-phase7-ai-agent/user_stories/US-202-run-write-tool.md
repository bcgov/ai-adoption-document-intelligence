...
- [x] **Scenario 1**: `startRun` tool registered
...
- [x] **Scenario 2**: Source-derived workflows don't require `initialCtx`
...
- [x] **Scenario 3**: Missing required input surfaces as structured error
...
- [x] **Scenario 4**: Tool not registered until Milestone C completes
...
- [x] **Scenario 5**: Unit tests cover `startRun`
