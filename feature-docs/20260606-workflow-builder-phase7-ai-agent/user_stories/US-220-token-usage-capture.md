...
- [ ] **Scenario 1**: Translator extracts usage from `agent-done` events
...
- [ ] **Scenario 2**: `AgentService.runChat()` persists usage to the assistant message row
...
- [ ] **Scenario 3**: Conversation detail endpoint exposes usage
...
- [ ] **Scenario 4**: No frontend rendering of usage in 7.0
...
- [ ] **Scenario 5**: Tests cover capture + persistence
