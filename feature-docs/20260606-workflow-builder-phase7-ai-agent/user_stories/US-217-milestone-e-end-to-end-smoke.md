...
- [ ] **Scenario 1**: Smoke script exists at `/tmp/wb-phase7-milestone-e/smoke.mjs`
...
- [ ] **Scenario 2**: Agent creates the workflow + navigates the user
...
- [ ] **Scenario 3**: Agent adds source.upload + frontend uploads the queued file
...
- [ ] **Scenario 4**: Agent composes downstream + runs the workflow
...
- [ ] **Scenario 5**: Smoke pass criteria
    - **Given** the full run
