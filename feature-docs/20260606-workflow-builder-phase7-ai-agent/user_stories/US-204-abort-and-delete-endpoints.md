...
- [x] **Scenario 1**: `AbortFlagMap` singleton tracks in-flight streams
...
- [x] **Scenario 2**: `AgentService.runChat()` checks the abort signal between SDK turns
...
- [x] **Scenario 3**: `POST /api/agent/conversations/:id/abort` endpoint
...
- [x] **Scenario 4**: `DELETE /api/agent/conversations/:id` endpoint
