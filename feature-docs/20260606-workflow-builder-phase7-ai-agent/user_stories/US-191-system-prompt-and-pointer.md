...
- [x] **Scenario 1**: Canonical system prompt file created
...
- [x] **Scenario 2**: `.claude/agents/workflow-builder.md` pointer file created
    - **Given** the repo root
...
- [x] **Scenario 3**: Prompt loader function
...
- [x] **Scenario 4**: Loader unit tests
...
- [x] **Scenario 5**: Prompt content includes the dynamic-node escape-hatch rule explicitly
