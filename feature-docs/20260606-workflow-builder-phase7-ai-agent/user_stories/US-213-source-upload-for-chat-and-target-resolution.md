...
- [x] **Scenario 1**: `useSourceUploadForChat` mutation
...
- [x] **Scenario 2**: `resolveDropTarget` derives the target node id
...
- [x] **Scenario 3**: Drop handler dispatches via the resolver
...
- [x] **Scenario 4**: Successful upload adds a system-style message to the chat
...
- [x] **Scenario 5**: Tests for both pieces
