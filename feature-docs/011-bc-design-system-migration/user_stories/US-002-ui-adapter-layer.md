...
- [x] **Scenario 1**: UI adapter folder exists
...
- [x] **Scenario 2**: B.C. Design System components are preferred
...
- [x] **Scenario 3**: Mantine fallbacks are explicit
...
- [x] **Scenario 4**: Product code uses adapters for migrated UI
...
- [x] **Scenario 5**: Compatibility matrix is created
