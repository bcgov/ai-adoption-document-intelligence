...
- [ ] **Scenario 1**: B.C. Design System dependencies are installed
...
- [ ] **Scenario 2**: BC Sans is loaded for end users
...
- [ ] **Scenario 3**: B.C. Design System tokens are available globally
...
- [ ] **Scenario 4**: Mantine theme aligns with B.C. foundations
...
- [ ] **Scenario 5**: Existing app behaviour remains intact
