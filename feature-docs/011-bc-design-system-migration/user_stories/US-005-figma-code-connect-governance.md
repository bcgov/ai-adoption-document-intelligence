...
- [x] **Scenario 1**: Components are classified
...
- [x] **Scenario 2**: Figma naming guidance is documented
...
- [x] **Scenario 3**: Code Connect scope is defined
...
- [x] **Scenario 4**: Code Connect strategy is documented
    ...
    - **Then** documentation identifies which local wrappers and app-specific components are candidates for future Code Connect mappings and where mapping files are expected to live

- [x] **Scenario 5**: Sync workflow is documented
