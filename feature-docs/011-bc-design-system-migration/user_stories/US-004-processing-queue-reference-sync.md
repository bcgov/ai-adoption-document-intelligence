...
- [ ] **Scenario 1**: Page structure matches the Figma reference
...
- [ ] **Scenario 2**: Copy matches the Figma reference where appropriate
...
- [ ] **Scenario 3**: Migrated primitives use the UI adapter layer
...
- [ ] **Scenario 4**: Table remains functional
...
- [ ] **Scenario 5**: Responsive behaviour is retained
...
- [ ] **Scenario 6**: Tests and checks pass
