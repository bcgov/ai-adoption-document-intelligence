...
- [ ] **Scenario 1**: Single-typed-port output handle is colour-coded
...
- [ ] **Scenario 2**: Zero-typed-port and multi-typed-port handles stay gray
...
- [ ] **Scenario 3**: Hover tooltip on a coloured handle shows the kind literal
...
- [ ] **Scenario 4**: Hover tooltip on a gray multi-port handle explains the indirection
...
- [ ] **Scenario 5**: `handleConnect` behaviour unchanged
