...
- [x] **Scenario 1**: `PortDescriptor` grows optional `kind?: KindRef`
...
- [x] **Scenario 2**: `CtxDeclaration` grows optional `kind?: KindRef`
...
- [x] **Scenario 3**: `LibraryPortDescriptor` grows optional `kind?: KindRef`
    - **Given** `packages/graph-workflow/src/types.ts`
    - **When** read
...
- [x] **Scenario 4**: Package builds + validator tests stay green
