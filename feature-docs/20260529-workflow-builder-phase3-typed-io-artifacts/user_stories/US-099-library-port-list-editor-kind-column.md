...
- [x] **Scenario 1**: New "Kind" column renders alongside the existing columns
...
- [x] **Scenario 2**: Kind Select uses the same options as US-098
...
- [x] **Scenario 3**: Save flow persists `kind` onto `LibraryPortDescriptor`
...
- [x] **Scenario 4**: "—" stripped on save; legacy libraries reload cleanly
