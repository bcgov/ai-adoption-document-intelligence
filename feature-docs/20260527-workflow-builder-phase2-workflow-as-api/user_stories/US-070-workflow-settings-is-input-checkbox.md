...
- [x] **Scenario 1**: Each ctx row has an "Input" checkbox
...
- [x] **Scenario 2**: Checking the box updates the in-flight config
...
- [x] **Scenario 3**: Unchecking removes / sets-false the flag
...
- [x] **Scenario 4**: Loaded workflows reflect persisted flag values
