...
- [x] **Scenario 1**: Button is present and labeled
...
- [x] **Scenario 2**: Click opens `RunWorkflowDrawer`
...
- [x] **Scenario 3**: Disabled in create mode
...
- [x] **Scenario 4**: Drawer closes on close icon / backdrop
