...
- [ ] **Scenario 1**: `CtxDeclaration` carries an optional `isInput` flag
...
- [ ] **Scenario 2**: Existing workflow configs remain valid
...
- [ ] **Scenario 3**: Validator accepts a config with `isInput: true`
...
- [ ] **Scenario 4**: Package builds + tests pass
