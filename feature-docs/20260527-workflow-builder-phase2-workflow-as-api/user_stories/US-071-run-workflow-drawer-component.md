...
- [x] **Scenario 1**: Component fetches `run-spec` on open
...
- [x] **Scenario 2**: Trigger URL section
...
- [x] **Scenario 3**: Input schema section — library workflow
...
- [x] **Scenario 4**: Input schema section — regular workflow with no inputs
...
- [x] **Scenario 5**: Sample curl section
