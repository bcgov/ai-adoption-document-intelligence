...
- [ ] **Scenario 1**: SegmentedControl is present above the list
...
- [ ] **Scenario 2**: "Workflows" tab calls the backend with no `kind` filter, including default exclusion
...
- [ ] **Scenario 5**: Row links unchanged
...
- [ ] **Scenario 6**: Empty state per tab
