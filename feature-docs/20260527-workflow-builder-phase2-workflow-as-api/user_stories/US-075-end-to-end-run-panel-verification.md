...
- [ ] **Scenario 1**: Backend run-spec for a regular workflow
...
- [ ] **Scenario 2**: Backend run-spec for a library workflow
...
- [ ] **Scenario 3**: Backend POST /runs happy path
...
- [ ] **Scenario 4**: Backend POST /runs rejects bad input
...
- [ ] **Scenario 5**: Frontend Run drawer opens for a regular workflow
...
- [ ] **Scenario 6**: Frontend paste-and-run produces a workflowId
...
- [ ] **Scenario 7**: Frontend Run drawer for a library workflow
...
- [ ] **Scenario 8**: Workflow list filter
