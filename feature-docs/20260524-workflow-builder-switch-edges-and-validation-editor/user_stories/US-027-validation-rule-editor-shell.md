...
- [ ] **Scenario 1**: Empty list shows a helper line + "Add rule" button
...
- [ ] **Scenario 5**: Removing a rule shrinks the array
...
- [ ] **Scenario 6**: Rule rows render their variant body via discriminated-union dispatch
