...
## Acceptance Criteria
- [x] **Scenario 1**: Documents are scoped to the active group
...
- [x] **Scenario 2**: Document list refreshes when active group changes
...
- [x] **Scenario 5**: Empty list shown when active group has no documents
