...
## Acceptance Criteria
- [ ] **Scenario 1**: Projects are scoped to the active group
...
- [ ] **Scenario 2**: Project list refreshes when active group changes
...
- [ ] **Scenario 5**: Empty list shown when active group has no projects
