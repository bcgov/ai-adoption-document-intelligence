...
## Acceptance Criteria
- [x] **Scenario 1**: Page lists all available groups
...
- [x] **Scenario 2**: User can submit a membership request
...
- [x] **Scenario 3**: Success state is shown after submission
...
- [x] **Scenario 4**: Error state is shown on failure
    - **Given** the API request fails
    - **When** the response is received
    - **Then** the page displays an appropriate error message

- [x] **Scenario 5**: Page is accessible to any authenticated user
...
- [x] **Scenario 6**: Page is linked from the header empty-groups message
