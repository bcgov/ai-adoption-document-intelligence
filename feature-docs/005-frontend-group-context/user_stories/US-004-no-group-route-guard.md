...
## Acceptance Criteria
- [x] **Scenario 1**: User with no groups is redirected
...
- [x] **Scenario 2**: Direct URL entry is blocked
...
- [x] **Scenario 3**: Guard does not flash during loading
...
- [x] **Scenario 4**: System-admin is exempt from the guard
...
- [x] **Scenario 5**: Guard lifts after user gains membership
