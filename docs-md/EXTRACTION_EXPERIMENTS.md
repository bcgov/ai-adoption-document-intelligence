...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-04-vlm-direct-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 04` or `npx tsx scripts/trigger-experiment-benchmark.ts 04`. |
...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-05-vlm-ocr-hybrid-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 05` or `npx tsx scripts/trigger-experiment-benchmark.ts 05`. Cache rows verified: 40/40. |
