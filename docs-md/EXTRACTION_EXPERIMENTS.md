...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-02-mistral-doc-ai-azure-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 02`. |
...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-03-content-understanding-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 03`. |
...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-04-vlm-direct-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 04` or `npx tsx src/scripts/trigger-experiment-benchmark.ts 04`. |
...
| 11 | Benchmark integration | ✅ | Auto-discovered from JSON template; `seed-experiment-05-vlm-ocr-hybrid-definition` seeded against `seed-local-samples-mix-public-v1`. Trigger via `./scripts/run-experiment-benchmarks.sh 05` or `npx tsx src/scripts/trigger-experiment-benchmark.ts 05`. Cache rows verified: 40/40. |
