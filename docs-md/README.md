...
| Folder | Contents |
| --- | --- |
| [architecture/](architecture/) | System-level design: HITL architecture, database services and roles, blob storage, reference data tables, template models, shared packages, audit table, high availability |
...
| [workflows/](workflows/) | DAG workflow engine, graph types, adding nodes/activities/OCR providers, workflow builder, node catalog, lineage/versions, config overrides, Temporal worker concurrency, [templates/](workflows/templates/) example configs |
