...
- [ ] **3.17a Right-click acts on the whole selection (2026-08-03).** Shift-click (or marquee) **three** nodes, then right-click **one of them**. **Pass:** the menu is headed *"3 steps selected"* and offers **Group these 3 steps**, **Delete 3 steps**, and **Ungroup** only if they are in a group. **Change activity type** and **Edit script** are **absent** — they mean nothing for a set.
