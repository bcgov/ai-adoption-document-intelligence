...
Run id: `ensemble-S1_per_category_best`  •  status: `completed`  •  generated by `apps/temporal/src/scripts/dump-errors-for-gt-cleanup.ts` from `experiments/results/06-engine-ensemble/benchmark-run.json`.
