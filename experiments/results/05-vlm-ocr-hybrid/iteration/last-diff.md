...
Deployment: **gpt-5.4**  •  Total fields: **74**  •  Matched: **72**  •  Mismatched: **2**  •  Field-accuracy: **97.3%**
OCR (DI prebuilt-layout): 5297 ms (4092 markdown chars)  •  VLM call: 17302 ms.  fields populated=50/74 • evidence quotes=50
...
|---|---|---|---|
| `applicant_spousal_support_alimony` | 0 | "" | Spousal Support / Alimony 0 |
| `name` | "X" | "" | X |
