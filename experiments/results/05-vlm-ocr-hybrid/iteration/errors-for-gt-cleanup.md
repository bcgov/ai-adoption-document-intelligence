...
Aggregate: pass_rate **0.975** (39/40), f1.median **0.973**, f1.mean **0.948**, matchedFields.median **71**.
...
| `signature` | "LILNATHAE" | ["SIGNATURE", "Signature"] |
| `applicant_oas_gis` | null | "0" |
| `applicant_room_board_income` | null | "0" |
| `applicant_child_tax_benefits` | null | "0" |
...
| `signature` | "Indf line" | ["Smith Fake", "Smith Fake."] |
...
**Total mismatches listed: 171 across 33 samples** (2 known-hard samples flagged inline).
