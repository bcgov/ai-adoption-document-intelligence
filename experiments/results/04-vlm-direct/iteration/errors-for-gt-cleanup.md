...
Aggregate: pass_rate **0.800** (32/40), f1.median **0.903**, f1.mean **0.874**, matchedFields.median **66**.
...
| `signature` | "Nwflhic" | ["Smith Fake", "Smith Fake."] |
...
| `signature` | "EILE/NFTLIHE" | ["SIGNATURE", "Signature"] |
...
**Total mismatches listed: 365 across 39 samples** (2 known-hard samples flagged inline).
