...
Aggregate: pass_rate **1.000** (40/40), f1.median **0.943**, f1.mean **0.924**, matchedFields.median **66**.
...
| `spouse_date` | "2015-JUL-12" | ["2015-07-12", "2015-Jul-12"] |
| `spouse_sin` | "17011504" | ["170191504", "170 191 504", "170-191-504"] |
...
| field_key | predicted (engine, on the form) | expected (current GT) |
|---|---|---|
| `sin` | "555201979" | ["555231979", "555 231 979", "555-231-979"] |
...
| field_key | predicted (engine, on the form) | expected (current GT) |
|---|---|---|
| `date` | "2023-11-23" | ["2025-Nov-23", "2025- Nov-23"] |
