 ...
 * Palette entries land on the canvas by click-to-add or by dragging them
 * onto it (this page owns the drop handler that places the node at the
 * release point); drag the node to position; click to select; the right
 * panel renders the catalog-driven settings form for the selected node.
 * Nodes can be collected into named groups, with a simplified view that
 * collapses each group to a chip. Save persists via the existing
