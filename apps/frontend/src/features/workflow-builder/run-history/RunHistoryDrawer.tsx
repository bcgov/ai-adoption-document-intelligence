 ...
 *   - Loading (3 Skeleton rows), empty (an editor-runs-only explainer,
 *     or "No runs match these filters." while any filter is active),
      ...
      {isLoading ? (
        ...
        <Text size="sm" c="dimmed" data-testid="run-history-drawer-empty">
          {Object.values(filters).some((value) => value !== undefined)
            ...
            : "No editor runs yet — runs started from the editor appear " +
              "here. Production API runs are monitored in the Processing " +
              "queue."}
        </Text>
      ) : (
