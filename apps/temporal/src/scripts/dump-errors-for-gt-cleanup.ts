 ...
 *     src/scripts/dump-errors-for-gt-cleanup.ts <slug>
 *
 ...
 *   npx tsx -r tsconfig-paths/register src/scripts/dump-errors-for-gt-cleanup.ts 02-mistral-doc-ai-azure
 *
 *   # E03 with no known-hard exclusions
 *   npx tsx -r tsconfig-paths/register src/scripts/dump-errors-for-gt-cleanup.ts 03-content-understanding --known-hard ""
 *
...
function writeReport(args: {
  ...
  lines.push("");
  lines.push(
    `Run id: \`${run.id}\`  •  status: \`${run.status}\`  •  generated by \`apps/temporal/src/scripts/dump-errors-for-gt-cleanup.ts\` from \`${path.relative(path.resolve(__dirname, "..", "..", "..", ".."), exportPath)}\`.`,
  );
  lines.push("");
  lines.push(
