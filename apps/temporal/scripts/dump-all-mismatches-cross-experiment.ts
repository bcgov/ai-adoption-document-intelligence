 ...
 *     scripts/dump-all-mismatches-cross-experiment.ts
 *
...
function main(): void {
  ...
  lines.push("");
  lines.push(
    `Generated by \`apps/temporal/scripts/dump-all-mismatches-cross-experiment.ts\` from each experiment's \`benchmark-run.json\` after running the canonical promote + reeval to convergence.`,
  );
  lines.push("");
  lines.push(
