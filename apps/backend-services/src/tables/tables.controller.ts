...
export class TablesController {
  ...
  @Identity({
    ...
    groupPermissions: {
      ...
      requiredPermissions: [Permission.TABLE_RETRIEVE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      ...
      requiredPermissions: [Permission.TABLE_CREATE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_UPDATE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_DELETE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_COLUMN_CREATE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_COLUMN_UPDATE],
    },
  })
  ...
  @ApiBadRequestResponse({
    description:
      "Invalid column definition, seed_value invalid or misused, or table not found",
  })
  @ApiConflictResponse({
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_COLUMN_DELETE],
    },
  })
  @ApiOperation({ summary: "Remove a column from a table " })
  @ApiParam({ name: "tableId", description: "Stable table identifier" })
  ...
  @ApiOperation({ summary: "Add a lookup to a table" })
  @ApiParam({ name: "tableId", description: "Stable table identifier" })
  @ApiQuery({ name: "group_id", required: true, type: String })
  ...
  @ApiOperation({ summary: "Update a lookup definition" })
  @ApiParam({ name: "tableId", description: "Stable table identifier" })
  ...
  @ApiOperation({ summary: "Remove a lookup from a table" })
  @ApiParam({ name: "tableId", description: "Stable table identifier" })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_ROW_RETRIEVE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_ROW_CREATE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_ROW_UPDATE],
    },
  })
  ...
  @Identity({
    ...
    groupPermissions: {
      groupIdFrom: { query: "group_id" },
      requiredPermissions: [Permission.TABLE_ROW_DELETE],
    },
  })
