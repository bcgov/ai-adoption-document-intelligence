...
- Beyond that, use \`describeNode\` on each node to set required PARAMETERS (e.g. an OCR model id) — parameters are values you set, not bindings. Don't \`declareCtx\` or hand-bind anything auto-wire already covers.
