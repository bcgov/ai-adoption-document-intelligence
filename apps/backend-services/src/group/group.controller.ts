import { Controller, Post, Body, Param, HttpException, HttpStatus, Delete, Get, Query } from '@nestjs/common';
...
export class GroupController {
  ...
  @ApiResponse({ status: 200, description: 'List of groups the user is a member of.' })
  ...
  @ApiResponse({ status: 200, description: 'Membership requested successfully.' })
  @ApiParam({ name: 'userId', description: 'User ID', type: String })
  @ApiParam({ name: 'groupId', description: 'Group ID', type: String })
  @Post('/request')
  ...
  @ApiBody({ schema: { properties: { name: { type: 'string', description: 'Group name' } } } })
  @Post()
  async createGroup(
  ...
  @ApiResponse({ status: 200, description: 'User assigned to groups successfully.' })
  @ApiResponse({ status: 400, description: 'Invalid input.' })
  @ApiParam({ name: 'userId', description: 'User ID', type: String })
  @ApiBody({ schema: { properties: { groupIds: { type: 'array', items: { type: 'string' }, description: 'Array of group IDs' } } } })
  @Post('user/:userId')
