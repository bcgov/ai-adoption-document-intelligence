...
export class VersionListItemDto {
  ...
  @ApiPropertyOptional({ description: 'Splits associated with this version', type: () => SplitListItemDto, isArray: true })
  splits?: SplitListItemDto[];
}

export class VersionListResponseDto {
  @ApiProperty({ description: 'List of dataset versions', type: () => VersionListItemDto, isArray: true })
