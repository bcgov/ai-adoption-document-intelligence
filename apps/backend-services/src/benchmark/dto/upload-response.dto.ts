...
export class UploadResponseDto {
  ...
  @ApiProperty({ description: 'List of uploaded files', type: () => UploadedFileDto, isArray: true })
  ...
  @ApiProperty({ description: 'Version info for the upload', type: () => UploadVersionDto })
